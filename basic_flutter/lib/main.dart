...
class MyHomePageState extends State<MyHomePage> {
  ...
  addArticle(Article article) async {
    try {
      var result = await client.basicEndPoints.addArticle(article);
  ...
  fetchArticles() async {
    try {
      _articles = await client.basicEndPoints.getArticles();
      setState(() {});
    } on Exception catch (e) {
      debugPrint('$e');
    }
  ...
  updateArticle(Article article) async {
    try {
      var result = await client.basicEndPoints.editArticle(article);
  ...
  deleteArticle(int id) async {
    try {
      var result = await client.basicEndPoints.deleteArticle(id);
